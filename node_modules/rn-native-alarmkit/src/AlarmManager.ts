...
import { AlarmCapability, AlarmError, AlarmErrorCode, AlarmValidation } from './types';
...
class AlarmManager implements INativeAlarmManager {
  ...
  async checkCapability(): Promise<AlarmCapabilityCheck> {
    ...
    try {
      ...
      console.warn('[AlarmManager] Capability:', capability);
      return capability;
    } catch (error) {
  ...
  async requestPermission(): Promise<boolean> {
    try {
      ...
      console.warn('[AlarmManager] Permission granted:', granted);
      return granted;
    } catch (error) {
